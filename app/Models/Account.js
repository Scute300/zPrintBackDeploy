...
class Account extends Orm_1.BaseModel {
    static async hashPassword(account) {
        if (account.$dirty.password) {
            account.password = await Hash_1.default.make(account.password);
        }
    }
}
__decorate([
...
], Account.prototype, "store_name", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Object)
], Account.prototype, "passwordrequest", void 0);
__decorate([
