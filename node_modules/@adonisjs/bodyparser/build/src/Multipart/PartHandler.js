...
class PartHandler {
    constructor(part, options) {
         ...
         */
        this.canFileTypeBeDetected = utils_2.supportMagicFileTypes.includes(path_1.extname(this.part.filename).replace(/^\./, ''));
        /**
     ...
     * are not deferred.
     */
    async detectFileTypeAndExtension(force) {
        if (!this.buff) {
            return;
        }
        const fileType = await utils_2.getFileType(this.buff, this.file.clientName, this.file.headers, force);
        if (fileType) {
