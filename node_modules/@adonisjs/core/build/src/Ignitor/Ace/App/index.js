...
class App {
    ...
    printVersion(value) {
        ...
        try {
            assemblerVersion = require(utils_1.resolveFrom(this.appRoot, '@adonisjs/assembler/package.json'))
                .version;
        }
        catch (error) { }
        cliui_1.sticker()
    ...
    async onFind(command) {
        ...
        if (!this.registeredTsHook && this.application.rcFile.typescript && !this.isAssemblerCommand) {
            utils_2.registerTsHook(this.application.appRoot);
    ...
    getAssemblerManifest() {
        try {
            const manifestAbsPath = utils_1.resolveFrom(this.application.appRoot, '@adonisjs/assembler/build/ace-manifest.json');
    ...
    getAppManifest() {
        try {
            const manifestAbsPath = utils_1.resolveFrom(this.application.appRoot, './ace-manifest.json');
